...
const AdminChatRoomComponent = () => {
  ...
  return (
    <>
      <Toast show={toast1} onClose={close1} className="ms-4 mb-5" style={{ maxHeight: '550px', }}>
        <Toast.Header>
          <strong className="me-auto">Chat with John Doe</strong> {/*classname="me-auto help allign the next ellement to the right" */}
        </Toast.Header>
        <Toast.Body >
          <div style={{ maxHeight: "300px", overflow: "auto" }}> {/*size of chat box and allow scrolling bar */}
